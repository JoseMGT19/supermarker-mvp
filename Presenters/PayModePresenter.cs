...
namespace Supermarket_mvp.Presenters
{
    ...
    {
        private IPayModelView view;
        private IPayModeRepository repository;
        private BindingSource payModeBindingSource;
        private IEnumerable<PayModeModel> payModeList;

        public PayModePresenter(IPayModelView view, IPayModeRepository repository)
        {
            ...
            this.view.DeleteEvent += DelecteSelectedPayMode;
        ...
        private void DelecteSelectedPayMode(object? sender, EventArgs e)
        {
            try
            {
            ...
            {
                view.IsSuccessful = false;
                view.Message = "Ah error ocurred, could not delete pay mode";
            }
        }
